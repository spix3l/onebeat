...
`OB-3-08` is ✅: [`model/note_edit.h`](../engine/src/model/note_edit.h) is the
single editing vocabulary used by the upcoming rack and piano roll. It covers
range/lasso selection, snapped move/resize, velocity edits, strength quantise,
