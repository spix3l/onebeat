...
- [ ] Every Stage 3 mutation (notes, patterns, clips, lanes, instruments, transport-agnostic settings) is undoable/redoable; a checklist in the PR enumerates them.
- [ ] Drag/paint gestures coalesce to single history entries.
- [ ] Instrument delete + undo restores sequences in all affected patterns byte-identically.
- [ ] Fuzz test (≥100k ops) passes under ASan.
