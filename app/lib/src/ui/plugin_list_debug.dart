    ...
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        if (library.showParameters && library.instance != null) {
          if (library.instance!.pluginId == 'dev.onebeat.stock.piano') {
            return _StockPianoEditor(library: library);
          }
...
class _StockPianoEditor extends StatelessWidget {
  const _StockPianoEditor({required this.library});
