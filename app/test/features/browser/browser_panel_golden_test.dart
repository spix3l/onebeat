// Browser panel (UI-B-04): a golden per content variant, plus the callbacks.
...
void main() {
  ...
  testWidgets('the tree variant renders as the golden', (
    WidgetTester tester,
  ) async {
    await pumpUi(
      tester,
    ...
    await expectLater(
      ...
      uiGolden('browser_tree'),
    );
  });

  testWidgets('the sample-list variant renders as the golden', (
    WidgetTester tester,
  ) async {
    await pumpUi(
      tester,
