// Meter ballistics tests for core infrastructure.
...
void main() {
  ...
  test(
    'decay over one second is the same whether drawn at 120 Hz or at 12 Hz',
    () {
      ...
      for (int frame = 1; frame <= 120; frame++) {
        fast.update(
          snapshotAt(1000000 + (oneSecond ~/ 120) * frame, 0),
          motion,
        );
      }
      // 12 frames of silence across the same second.
